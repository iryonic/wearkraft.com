    ...
    <header id="main-header" class="sticky top-0 z-50 py-4 lg:py-6 bg-white/90 backdrop-blur-md border-b-[3px] border-black transition-all duration-300">
        <div class="container mx-auto px-4 lg:px-20 flex items-center justify-between">
            ...
            <div class="flex items-center gap-6">
                <!-- Search -->
                <button id="open-search" class="hidden lg:flex w-14 h-14 bg-white border-[3px] border-black rounded-2xl items-center justify-center hover:bg-neon-yellow transition-all shadow-[2px_2px_0px_0px_#000] active:translate-x-0.5 active:translate-y-0.5 active:shadow-none group">
